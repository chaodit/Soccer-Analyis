...
var tip = d3.tip().attr('class', 'd3-tip')
    .html(function(d) {
        ...
        text += "Average Height： <span style='color:red'>" + d3.format(".2f")(d.average_height) + "</span><br>";
        return text;
    });
g.call(tip);
...
d3.json("team_all_season.json").then(function(data){
