...
var tip = d3.tip().attr('class', 'd3-tip')
    .html(function(d) {
        var text = "Manager Age Gap： <span style='color:red'>" + d.agegap + "</span><br>";   
        text += "Performance： <span style='color:red'>" + d3.format(".2f")(d.performance) + "</span><br>";
        return text;
    });
g.call(tip);

d3.json("visual_data/manager_ageSimi_new.json").then(function(data){
    console.log(data)  
